      ...
      <el-row>
        <div class="PageNext">
          ...
          <el-table
            ...
            :data="salaryList"
            class="borderLine"
            style="font-family:FangSong_GB2312;font-size:15pt;color:#000;line-height:22pt;letter-spacing:0px;width:590px;filter:alpha(Opacity=80);z-index:-100"
          >
          ...
          <el-col class="text-left" style="margin-top:10px">
            <span class="text1">
              ...
              <br />&#12288;&#12288;
              <b>2、年薪资奖励：</b>
              <br />&#12288;&#12288;（1）为2个月的月薪（含基本工资、满勤奖）。
              <br />&#12288;&#12288;（2）入职第一年或年内离职的按实际出勤计发。
              <br />&#12288;&#12288;
              <b>3、每月月薪</b>：已包含基本工资、满勤奖。
              <br />
        ...
        <div class="PageNext">
          <el-col style="text-align: justify;">
            <span class="text1">
              <span class="text2">
                <br />&#12288;&#12288;五、股权激励：
              </span>按照甲方的股权激励方案执行。<br />
              <span class="text2">&#12288;&#12288;六、签订协议的目的及保密</span>
...
export default {
  ...
  methods: {
    ...
    getRowClass({ row, column, rowIndex, columnIndex }) {
      return 'border-color: #000 !important;background-color: rgba(255,255,255,0);; '
    },
    //初始化
    initPage() {
      // this.first();
