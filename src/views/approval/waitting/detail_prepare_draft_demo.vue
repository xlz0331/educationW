<template>
  <div class="_container">
    ...
    <div :style="'max-height:'+tableHeight+'px;overflow-y: auto;border-top:'">
      ...
      <entry-pay-edit-demo ref="entryEdit" :instanceId="mainObj.fdId" :mainObj="mainObj" :formObj="formObj"></entry-pay-edit-demo>
    </div>
    ...
    <el-dialog title="人员选择" width="66%"  :key="keyVal" :close-on-click-modal="false"
...
<script>
  ...
  import EntryPayEditDemo from "@/views/approval/com/entry/entry_pay_edit_demo";
  ...
  export default {
    ...
    mounted() {
      ...
      this.getTableHeight();
      // this.$nextTick(() => {
      //   console.log(111,this.$refs.entryEdit.formData.hireDraftDto)
      //   this.formObj = this.$refs.entryEdit.formData.hireDraftDto || {};
      // })
    },
    beforeMount() {
