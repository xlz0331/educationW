    ...
    <div class="read-card text-center">
      ...
      <el-form :inline="true" label-width="100px">
        <el-form-item label="请刷身份证">
          <el-input size="small" v-model="nid"   :title="errorPlaceholder"
      ...
      checkNid(nid) {
        System_API.checkNid_sysBaseData({nid: nid}).then(res => {
          if (res.success) {//身份验证成功之后，将身份证信息保存至混存
            ...
            this.$confirm('【' + res.msg + "】，点击【确认】重新读取身份证？", '提示', {
          ...
          this.$confirm('【' + err.msg + "】，点击【确认】重新读取身份证？", '提示', {
            distinguishCancelAndClose: true,
            confirmButtonText: '确认',
            cancelButtonText: '取消',
            type: 'warning',
